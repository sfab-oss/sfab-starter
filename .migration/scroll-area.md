...
- `packages/ui/src/components/shadcn/scroll-area.tsx` — Radix primitives replaced with `@base-ui/react` base-vega registry variant.
- Leftover scan: `grep -n "radix-ui|@radix-ui" packages/ui/src/components/shadcn/scroll-area.tsx` → clean.
