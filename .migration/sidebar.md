...
2026-07-09, golden pair via CLI (shadcn add --overwrite after style flip to base-vega); customizations replayed by hand. Migrated.

## Changed

- `packages/ui/src/components/shadcn/sidebar.tsx` — Radix primitives replaced with `@base-ui/react` base-vega registry variant.
- Leftover scan: `grep -n "radix-ui|@radix-ui" packages/ui/src/components/shadcn/sidebar.tsx` → clean.
