...
- [`ALW-856`](./ALW-856.md) — Starter stale copy + voice STT key: "Acme Inc." manifest, "ERP Assistant" label, undocumented OPENAI_API_KEY
- [`ALW-855`](./ALW-855.md) — Starter IA reconciliation: live Catalog/Entities/Documents is the truth; demote operator-ux; fix registry phantom routes
- [`ALW-854`](./ALW-854.md) — Delete the committed .sfab/.tasks mirror in sfab-starter
...
- [`ALW-830`](./ALW-830.md) — Bump starter wrangler 4.124 + Cloudflare vite-plugin 1.53
...
- [`ALW-715`](./ALW-715.md) — Demote comment-hygiene out of AGENTS.md (template soft policy hurts)
