...
//      via `mainModule: typeof import("../../../apps/web-tanstack/src/server")`.
//   2. `DurableObjectNamespace<import("../../../apps/web-tanstack/src/...").Class>`
//      — added whenever a DO binding is declared. Replaced with the bare
//      `DurableObjectNamespace` type.
//   3. `Workflow<Parameters<import("../../../apps/web-tanstack/src/...").Class['run']>...>`
