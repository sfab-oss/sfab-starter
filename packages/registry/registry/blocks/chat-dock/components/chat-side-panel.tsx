...
function FilesTab({
  ...
  // Mobile: no room for a side-by-side split, so stack it — the tree fills the
  // sheet, tapping a file pushes its content with a back affordance.
  if (isMobile) {
    if (fileName && activeFilePath) {
      return (
